...
document.querySelector(".submit-btn").addEventListener("click", function () {
    ...
    if (document.querySelector("#fname").value == ""
        ...
        //          <p>Please excuse ${userFirstName} ${userLastName} from work ${illnessDate}. He/She/They ${userSymptoms} and shouldn't be coming to work for his/her/their own safety as well as their coworkers. 
